...
> 文档状态：已按「5 Tab + 6 能力域 + 全局入口」重构；**§4.10～§4.12、§5.1 收租 Tab 界面要素已与 `pencil/rentimate-rent.pen` 当前画板对齐**
...
源文件：`pencil/rentimate-rent.pen`（iPhone 14 Pro 宽 393px；R-01 画板高 **852**，R-02～R-04c / R-03 子页高 **844**；R-02 详情为 `fit_content` 高度随内容）
...
**最后更新**：2026-05-29（对照 `rentimate-rent.pen` 全量校准 §4.10、§5.1 收租 Tab 界面要素与 §11 色值/画板尺寸）
